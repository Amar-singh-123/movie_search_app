...
MovieImageListData movieImageListDataFromJson(String str) => MovieImageListData.fromJson(json.decode(str));

String movieImageListDataToJson(MovieImageListData data) => json.encode(data.toJson());

class MovieImageListData {
  ...
  factory MovieImageListData.fromJson(Map<String, dynamic> json) => MovieImageListData(
