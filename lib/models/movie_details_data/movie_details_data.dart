...
MovieDetailsData movieDetailsDataFromJson(String str) => MovieDetailsData.fromJson(json.decode(str));

String movieDetailsDataToJson(MovieDetailsData data) => json.encode(data.toJson());
...
class MovieDetailsData {
  ...
  factory MovieDetailsData.fromJson(Map<String, dynamic> json) => MovieDetailsData(
    adult: json["adult"],
